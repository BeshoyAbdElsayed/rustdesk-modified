...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_cert_tip", "Install CYMTV Remote certificate"),
        ("comfirm_install_cert_tip", "This is a CYMTV Remote testing certificate, which can be trusted. The certificate will be used to trust and install CYMTV Remote drivers when required."),
        ...
        ("verify_rustdesk_password_tip", "Verify CYMTV Remote password"),
